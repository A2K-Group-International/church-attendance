...
import DialogRegister from "@/registration/DialogRegister";
import DialogEditRegistration from "@/editRegistration/DialogEditRegistration";
const Home = () => {
  return (
    <>
      {/* Hero */}
